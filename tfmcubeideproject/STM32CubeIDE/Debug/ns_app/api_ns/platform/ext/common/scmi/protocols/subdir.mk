...
C_SRCS += \
../ns_app/api_ns/platform/ext/common/scmi/protocols/scmi_power_domain.c \
../ns_app/api_ns/platform/ext/common/scmi/protocols/scmi_system_power.c 

OBJS += \
./ns_app/api_ns/platform/ext/common/scmi/protocols/scmi_power_domain.o \
./ns_app/api_ns/platform/ext/common/scmi/protocols/scmi_system_power.o 

C_DEPS += \
./ns_app/api_ns/platform/ext/common/scmi/protocols/scmi_power_domain.d \
./ns_app/api_ns/platform/ext/common/scmi/protocols/scmi_system_power.d 


# Each subdirectory must supply rules for building sources it contributes
ns_app/api_ns/platform/ext/common/scmi/protocols/%.o ns_app/api_ns/platform/ext/common/scmi/protocols/%.su ns_app/api_ns/platform/ext/common/scmi/protocols/%.cyclo: ../ns_app/api_ns/platform/ext/common/scmi/protocols/%.c ns_app/api_ns/platform/ext/common/scmi/protocols/subdir.mk
...
clean: clean-ns_app-2f-api_ns-2f-platform-2f-ext-2f-common-2f-scmi-2f-protocols

clean-ns_app-2f-api_ns-2f-platform-2f-ext-2f-common-2f-scmi-2f-protocols:
	-$(RM) ./ns_app/api_ns/platform/ext/common/scmi/protocols/scmi_power_domain.cyclo ./ns_app/api_ns/platform/ext/common/scmi/protocols/scmi_power_domain.d ./ns_app/api_ns/platform/ext/common/scmi/protocols/scmi_power_domain.o ./ns_app/api_ns/platform/ext/common/scmi/protocols/scmi_power_domain.su ./ns_app/api_ns/platform/ext/common/scmi/protocols/scmi_system_power.cyclo ./ns_app/api_ns/platform/ext/common/scmi/protocols/scmi_system_power.d ./ns_app/api_ns/platform/ext/common/scmi/protocols/scmi_system_power.o ./ns_app/api_ns/platform/ext/common/scmi/protocols/scmi_system_power.su

.PHONY: clean-ns_app-2f-api_ns-2f-platform-2f-ext-2f-common-2f-scmi-2f-protocols
