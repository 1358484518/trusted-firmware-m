...
DEFAULT_IRQ_HANDLER(GPDMA2_Channel8_IRQHandler)
DEFAULT_IRQ_HANDLER(GPDMA2_Channel9_IRQHandler)
DEFAULT_IRQ_HANDLER(GPDMA2_Channel10_IRQHandler)
DEFAULT_IRQ_HANDLER(GPDMA2_Channel11_IRQHandler)
DEFAULT_IRQ_HANDLER(GFXTIM_IRQHandler)
DEFAULT_IRQ_HANDLER(LCD_IRQHandler)
DEFAULT_IRQ_HANDLER(LCD_GBL_ERROR_IRQHandler)
DEFAULT_IRQ_HANDLER(PLAY1_IRQHandler)
DEFAULT_IRQ_HANDLER(PLAY1_S_IRQHandler)
...
extern const pFunc __VECTOR_TABLE[];
  ...
  COMP_IRQHandler,                  /* 133: COMP1/COMP2 */
  DMA2D_IRQHandler,                 /* 134: DMA2D */
  JPEG_IRQHandler,                  /* 135: JPEG */
  GPDMA1_Channel8_IRQHandler,       /* 136 */
  GPDMA1_Channel9_IRQHandler,       /* 137 */
  GPDMA1_Channel10_IRQHandler,      /* 138 */
  GPDMA1_Channel11_IRQHandler,      /* 139 */
  GPDMA2_Channel8_IRQHandler,       /* 140 */
  GPDMA2_Channel9_IRQHandler,       /* 141 */
  GPDMA2_Channel10_IRQHandler,      /* 142 */
  GPDMA2_Channel11_IRQHandler,      /* 143 */
  GFXTIM_IRQHandler,                /* 144 */
  LCD_IRQHandler,                   /* 145 */
  LCD_GBL_ERROR_IRQHandler,         /* 146 */
  PLAY1_IRQHandler,                 /* 147 */
  PLAY1_S_IRQHandler,               /* 148 */
  ADC3_IRQHandler,                  /* 149 */
  OCTOSPI2_IRQHandler,              /* 150 */
  OTFDEC2_IRQHandler,               /* 151 */
  FDCAN3_IT0_IRQHandler,            /* 152 */
  FDCAN3_IT1_IRQHandler,            /* 153 */
  MDF1_FLT0_IRQHandler,             /* 154 */
  MDF1_FLT1_IRQHandler,             /* 155 */
  MDF1_FLT2_IRQHandler,             /* 156 */
  MDF1_FLT3_IRQHandler,             /* 157 */
  MDF1_FLT4_IRQHandler,             /* 158 */
  MDF1_FLT5_IRQHandler,             /* 159 */
  ADF1_FLT0_IRQHandler,             /* 160 */
#endif
};
#if defined ( __GNUC__ )
