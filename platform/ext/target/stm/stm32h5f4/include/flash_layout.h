 ...
 */
  ...
  * First-bring-up keeps the H573 slot map so BL2 stays at 0x0001_0000.
  * Extra 2 MB of the 4 MB flash is unused until SPE/NS slots are enlarged.
  *
  ...
  * 0x001f_8000 unused (to 0x0040_0000, 4 MB total)
  *
...
#define FLASH_B_SIZE                    (0x200000)   /* 2 MBytes per bank (H5F4) */
...
/* Last 1 KB of SRAM2 (128 KB at 0x30040000 on H5F4) */
#define BOOT_TFM_SHARED_DATA_BASE        (0x3005FC00)
