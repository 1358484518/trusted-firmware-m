...
#define _SRAM2_TOP              (0x60000) /* SRAM1+SRAM2 = 256+128 KB */
...
#define _FLASH_BASE_NS          (0x08000000) /*!< FLASH(4 MB) base address */
...
#define _FLASH_BASE_S           (0x0C000000) /*!< FLASH(4 MB) base address */
